 ...
 * the License.
 */
package com.project.generator.config.builder;

import com.baomidou.mybatisplus.annotation.DbType;
import com.baomidou.mybatisplus.core.toolkit.StringPool;
import com.baomidou.mybatisplus.core.toolkit.StringUtils;
import com.project.generator.InjectionConfig;
import com.project.generator.config.*;
import com.project.generator.config.po.TableField;
import com.project.generator.config.po.TableFill;
import com.project.generator.config.po.TableInfo;
import com.project.generator.config.querys.H2Query;
import com.project.generator.config.rules.NamingStrategy;
...
public class ConfigBuilder {
    ...
    private List<TableInfo> getTablesInfo(StrategyConfig config) {
        ...
        try {
            ...
            // 性能优化，只处理需执行表字段 github issue9s/21
