 ...
 * the License.
 */
package com.project.generator.engine;
...
import com.project.generator.config.TemplateConfig;
import com.project.generator.config.builder.ConfigBuilder;
import com.project.generator.config.po.TableInfo;
import com.project.generator.config.rules.FileType;
...
public abstract class AbstractTemplateEngine {
    ...
    public Map<String, Object> getObjectMap(TableInfo tableInfo) {
        ...
        tableInfo.setDaoNameUnderline(toLowerCaseFirstOne(tableInfo.getDaoName()));
